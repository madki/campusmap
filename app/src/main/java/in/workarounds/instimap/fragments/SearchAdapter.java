...
public class SearchAdapter extends BaseAdapter {
    ...
    private List<in.workarounds.instimap.models.Marker> resultList = null;
    private ArrayList<in.workarounds.instimap.models.Marker> inputList;
    private List<ScoredMarker> map;
    private Locale l;
    private String searchedText = "";
    private in.workarounds.instimap.helpers.SettingsManager settingsManager;
    private boolean turnOnResidences;

    public SearchAdapter(Context context, List<Marker> inputList) {
        mContext = context;
    ...
    public void filter(String charText) {
        ...
        if (charText.length() == 0) {
            if (settingsManager.showResidences()) {
                ...
                for (in.workarounds.instimap.models.Marker m : inputList) {
    ...
    private List<Marker> sortByScore(List<ScoredMarker> tempScore) {
        List<Marker> templist = new ArrayList<in.workarounds.instimap.models.Marker>();
    ...
    private void setSettingsManager(Context context) {
